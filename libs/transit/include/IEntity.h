...
class IEntity {
 public:
  ...
  /**
   * @brief Gets the observer object used to notify about the entity's actions
   
   * @return observer -the IEntityObserver object that is explained in the brief
   */
  virtual IEntityObserver* GetObserver() {return observer; }
  ...
  /**
   * @brief Generates a random float number
   * 
   * @param Min The lowest float number that should be generated.
   * @param Max The highest float number that should be generated
   * 
   * @return The randomly generated float number
   */
